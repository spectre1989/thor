...
void geobin_file_read(File_Handle file, const char* coh_data_path, Matrix_4x4* object_matrices, int32 num_object_matrices, int32* out_num_objects_in_scene, struct Linear_Allocator* temp_allocator);